    ...
    <footer className="relative pb-6 max-sm:pt-20 max-md:pt-32 text-system-white64">
      <div className="mx-20 max-sm:mx-4 max-lg:mx-[30px]">
        <div className="mb-8 flex justify-between py-3 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:gap-8">
          <div className="max-sm:flex max-sm:flex-col max-sm:items-center">
            ...
            <div>
              ...
              <div className="flex space-x-3 max-sm:justify-center">
                <div>
                  <a target="_blank" title="X" className="flex h-11 w-11 items-center justify-center rounded-full border-[1px] border-[#FFFFFF] text-white" rel="noopener noreferrer" href="https://x.com/ViduAI_official">
                    <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-[24px]">
                      <path d="M8.06055 5H4.56055L15.9355 19H19.4355L8.06055 5Z" stroke="currentColor" strokeLinecap="round" strokeWidth="1.3125"/>
                      <path d="M18.123 5L18.6018 5.44884L19.6378 4.34375H18.123V5ZM17.6855 5V4.34375H17.4012L17.2068 4.55116L17.6855 5ZM12.7324 10.75L12.2231 11.1638L12.6971 11.7472L13.2112 11.1988L12.7324 10.75ZM12.5293 10.5L12.0505 10.0512L11.6587 10.4692L12.02 10.9138L12.5293 10.5ZM10.6543 12.5L11.1636 12.0862L10.6896 11.5028L10.1755 12.0512L10.6543 12.5ZM4.56055 19L4.08179 18.5512L3.04577 19.6562H4.56055V19ZM4.99805 19V19.6562H5.28236L5.47681 19.4488L4.99805 19ZM10.8574 12.75L11.3362 13.1988L11.728 12.7808L11.3667 12.3362L10.8574 12.75ZM18.123 4.34375H17.6855V5.65625H18.123V4.34375ZM13.2112 11.1988L18.6018 5.44884L17.6443 4.55116L12.2537 10.3012L13.2112 11.1988ZM13.2417 10.3362L13.0386 10.0862L12.02 10.9138L12.2231 11.1638L13.2417 10.3362ZM17.2068 4.55116L12.0505 10.0512L13.0081 10.9488L18.1643 5.44884L17.2068 4.55116ZM10.1755 12.0512L4.08179 18.5512L5.03931 19.4488L11.1331 12.9488L10.1755 12.0512ZM4.56055 19.6562H4.99805V18.3438H4.56055V19.6562ZM5.47681 19.4488L11.3362 13.1988L10.3787 12.3012L4.51929 18.5512L5.47681 19.4488ZM10.145 12.9138L10.3481 13.1638L11.3667 12.3362L11.1636 12.0862L10.145 12.9138Z" fill="currentColor"/>
                    </svg>
                  </a>
                </div>
                <div>
                  <a target="_blank" title="Youtube" className="flex h-11 w-11 items-center justify-center rounded-full border-[1px] border-[#FFFFFF] text-white" rel="noopener noreferrer" href="https://www.youtube.com/channel/UChF9964qVeqdSL9MkzBwCig">
                    <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-[24px]">
                ...
                <div>
                  <a target="_blank" title="Tiktok" className="flex h-11 w-11 items-center justify-center rounded-full border-[1px] border-[#FFFFFF] text-white" rel="noopener noreferrer" href="https://www.tiktok.com/@vidu_ai?lang=en">
                    <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-[24px]">
                ...
                <div>
                  <a target="_blank" title="Discord" className="flex h-11 w-11 items-center justify-center rounded-full border-[1px] border-[#FFFFFF] text-white" rel="noopener noreferrer" href="https://discord.gg/3pDU8fmQ8Y">
                    <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-[24px]">
          ...
          <div className="flex flex-col items-start gap-2 px-4 text-sm leading-7 max-sm:items-center">
            <div className="mb-3 font-Syne text-base uppercase text-white">GET STARTED</div>
            <a target="_self" className="hover:cursor-pointer text-system-text03 hover:text-white" rel="nofollow" href="/create/character2video">Reference to Video</a>
            <a target="_self" className="hover:cursor-pointer text-system-text03 hover:text-white" rel="nofollow" href="/create/img2video">Image to Video</a>
            <a target="_self" className="hover:cursor-pointer text-system-text03 hover:text-white" rel="nofollow" href="/create/text2video">Text to Video</a>
          </div>
          <div className="flex flex-col items-start gap-2 px-4 text-sm leading-7 max-sm:items-center">
            <div className="mb-3 font-Syne text-base uppercase text-white">AI TOOLS</div>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-video-generator">AI Video Generator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-animation-generator">AI Animation Generator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-image-animator">AI Image Animator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-ad-generator">AI Video Ad Generator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-hug-generator">AI Hug Generator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="/ai-kissing-generator">AI Kissing Generator</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white flex items-center gap-2" href="/ai-video-tools">
              View All
          ...
          <div className="flex flex-col items-start gap-2 px-4 text-sm leading-7 max-sm:items-center">
            <div className="mb-3 font-Syne text-base uppercase text-white">For Enterprise</div>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" href="https://platform.vidu.com">API</a>
          </div>
          <div className="flex flex-col items-start gap-2 px-4 text-sm leading-7 max-sm:items-center">
            <div className="mb-3 font-Syne text-base uppercase text-white">COMPANY</div>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" rel="noreferrer nofollow" href="mailto:support@vidu.com">Contact Us: support@vidu.com</a>
            <a target="_blank" className="hover:cursor-pointer text-system-text03 hover:text-white" rel="noreferrer nofollow" href="https://www.vidu.com/en/cpp">Creative Partner Program</a>
          </div>
        </div>
