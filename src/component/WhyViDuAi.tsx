    ...
    <section className="relative flow-root h-full max-md:h-auto">
      <div className="mt-[134px] flex w-screen flex-col items-center overflow-hidden">
        ...
        <div className="font-normal text-[14px] text-base text-white opacity-65 max-md:mx-[58px] max-md:text-center max-md:leading-6">
          Vidu AI Video Generator delivers what others can't - trusted by
          millions worldwide.
        </div>
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 h-[500px] bg-gradient-to-t from-transparent to-black max-md:pointer-events-none max-md:h-[230px]"></div>
      </div>
{/* 
      <div className="relative flex w-[120%] justify-center max-md:w-[140%]" style={{ transform: "perspective(800px) rotateX(30deg)" }}>
        <div className="scrollbar-hide max-h-[500px] overflow-y-auto max-md:max-h-[250px]" style={{ WebkitOverflowScrolling: "touch" }}>
          <div className="flex flex-wrap justify-center gap-4 px-4">
            {[
              "banner2.39b0f5fa.png",
              "banner1.7a71aefe.png", 
              "banner5.771bdc66.png",
              "ability1.72782fe0.png",
              "ability2.c48cdf53.png",
              "ability3.85e5423d.png",
              "advantage1.90b2057f.png",
              "advantage2.596755e7.png",
              "advantage3.dc2ec0be.png",
              "scene1.bef8bc68.png",
              "scene3.f6cd1517.png",
              "scene2.a0d4400d.png",
              "last.944c30c3.png"
              ...
              <img
                ...
                src={`https://image01.cf.vidu.studio/vidu/landing-page/${image}`}
              />
            )).concat(
